...
public interface FarmerCollectionTable {

    String TABLE_REPORTS = "ReportsTable";
    String TABLE_TEMP_REPORT = "tempReportTable";
    ...
    String KEY_REPORT_INCENTIVE_RATE = "incentiveRate";
    String KEY_REPORT_INCENTIVE_AMOUNT = "incentiveAmount";
    /*String KEY_REPORT_TOTAl_AMOUNT = "totalAmount";*/

    String KEY_REPORT_KG_FAT = "kgFat";
    String KEY_REPORT_KG_SNF = "kgSnf";
    String KEY_REPORT_KG_CLR = "kgClr";
    ...
    String CREATE_REPORT_TABLE = "CREATE TABLE " + TABLE_REPORTS + "("
            ...
            + KEY_REPORT_SEQUENCE_NUMBER + " INTEGER," + KEY_REPORT_ROUTE + " TEXT,"
            + KEY_REPORT_RECORD_STATUS + " TEXT,"
            + KEY_REPORT_RATECHART_NAME + " TEXT,"
            + KEY_REPORT_KG_QTY + " DOUBLE," + KEY_REPORT_LTR_QTY + " DOUBLE," + KEY_TIPPING_START_TIME
            ...
            + KEY_REPORT_SALT + " DOUBLE,"
            + KEY_REPORT_FREEZING_POINT + " DOUBLE,"
            + KEY_REPORT_PH + " DOUBLE,"
            + KEY_REPORT_PROTEIN + " DOUBLE,"
            + KEY_REPORT_CONDUTIVITY + " DOUBLE,"
            + KEY_REPORT_LACTOSE + " DOUBLE, "
            + KEY_REPORT_DENSITY + " DOUBLE, "
            + KEY_REPORT_CALIBRATION + " TEXT, "
            + KEY_REPORT_INCENTIVE_RATE + " DOUBLE, "
            + KEY_REPORT_INCENTIVE_AMOUNT + " DOUBLE, "
            + KEY_REPORT_KG_FAT + " DOUBLE, "
            + KEY_REPORT_KG_SNF + " DOUBLE, "
            + KEY_REPORT_KG_CLR + " DOUBLE, "
    ...
    String CREATE_TEMP_REPORT_TABLE = "CREATE TABLE " + TABLE_TEMP_REPORT + "("
            + KEY_REPORT_COLUMNID + " INTEGER PRIMARY KEY, "
            + KEY_REPORT_FARMERID + " TEXT," + KEY_REPORT_NAME + " TEXT,"
            + KEY_REPORT_SNF + " TEXT," + KEY_REPORT_FAT + " TEXT,"
            + KEY_REPORT_USER + " TEXT," + KEY_REPORT_MANUAL + " TEXT,"
            + KEY_REPORT_AMOUNT + " TEXT,"
            + KEY_REPORT_QUANTITY + " TEXT,"
            ...
            + KEY_REPORT_RECORD_STATUS + " TEXT,"
            + KEY_REPORT_RATECHART_NAME + " TEXT,"
            + KEY_REPORT_KG_QTY + " TEXT," + KEY_REPORT_LTR_QTY + " TEXT," + KEY_TIPPING_START_TIME
            + " INTEGER, " + KEY_TIPPING_END_TIME + " INTEGER, " + KEY_REPORT_AGENT_ID
            + " TEXT, " + KEY_REPORT_MILKSTATUS_CODE + " INTEGER," + KEY_REPORT_RATE_CALC_DEVICE
            + " INTEGER,"
            + KEY_REPORT_MA_SERIAL + " INTEGER,"
