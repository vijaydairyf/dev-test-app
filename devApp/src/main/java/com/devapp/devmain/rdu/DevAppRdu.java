...
public class DevAppRdu implements Rdu {
    @Override
    public String getReportMsg(ReportEntity reportEntity, boolean displayBonus, boolean roundOffqty) {
        ...
        String farmer = "00000", Qty = "000.00", fat = "00.00", snf = "00.00", rate = "00.00", amt = "0000.00";
    ...
    public String getResetMsg(boolean isEight) {
        ...
        if (isEight) {
            ...
            String farmer = "88888", Qty = "888.88", fat = "88.88", snf = "88.88", rate = "88.88", amt = "8888.88";
