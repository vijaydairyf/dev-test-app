...
public class EditMCCCollectionRecordSet extends RecordSet {


    private static EditMCCCollectionRecordSet editMccCollectionRecordSet;
    ...
    private EditMCCCollectionRecordSet() {
    ...
    public static EditMCCCollectionRecordSet getInstance(Context context) {

        if (editMccCollectionRecordSet == null) {
            mContext = context;
            editMccCollectionRecordSet = new EditMCCCollectionRecordSet();
        }

        return editMccCollectionRecordSet;
    }


    @Override
    String getRecordType() {
        return CollectionConstants.EDITED_MCC_COLLECTION;
    }
    ...
    ArrayList<? extends SynchronizableElement> getUnsentRecords(DateShiftEntry dateShiftEntry) {
        String query = getQueryForUnsentRecords(dateShiftEntry,
                RecordSet.EDITED_MCC_TYPE);
        ArrayList<EditedCenterPostEntity> allFarmerPostRecords = getCollectionList(query);
        return allFarmerPostRecords;
    }


    public ArrayList<EditedCenterPostEntity> getCollectionList(String query) {

        ArrayList<EditedCenterPostEntity> allPostFarmerEditRecords = new ArrayList<>();
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            do {
                EditedCenterPostEntity editedFarmerPostEntity = new EditedCenterPostEntity();
                ...
                farmerCollectionId.agent = cursor.getString(
